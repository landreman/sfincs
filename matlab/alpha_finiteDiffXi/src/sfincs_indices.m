function indices = sfincs_indices(ispecies, ix, ixi, ialpha, izeta, whichBlock, v)
...
switch whichBlock
    case v.BLOCK_F
        indices = (ispecies-1)*v.Nx*v.Nxi*v.Nalpha*v.Nzeta ...
            +(ix-1)*v.Nxi*v.Nalpha*v.Nzeta ...
            +(ixi-1)*v.Nalpha*v.Nzeta ...
            +(ialpha-1)*v.Nzeta ...
            +izeta;
    ...
    case v.BLOCK_QN
        ...
        %}
        indices = v.Nspecies*v.Nx*v.Nxi*v.Nalpha*v.Nzeta ...
            +(ialpha-1)*v.Nzeta ...
            +izeta;
    ...
    case v.BLOCK_DENSITY_CONSTRAINT
        ...
        indices = v.Nspecies*v.Nx*v.Nxi*v.Nalpha*v.Nzeta ...
            + (ispecies-1)*2 + 1;
        if v.includePhi1
            indices = indices + v.Nalpha*v.Nzeta + 1;
        end
