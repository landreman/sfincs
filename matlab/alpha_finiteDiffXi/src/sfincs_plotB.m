...
global alpha2D zeta2D Nzeta zeta
...
if Nzeta==1
    ...
    contourf(zeta2D, alpha2D, BHat, numContours, 'EdgeColor','none')
    colorbar
    hold on
    if iota>0
    ...
    colorbar
    hold on
    plot(zeta2D, alpha2D, '.k')
    xlabel('\alpha')
    ylabel('\zeta')
    title('BHat. Dots show (alpha,zeta) grid.','Interpreter','none')
    
    subplot(numRows,numCols,plotNum); plotNum = plotNum + 1;
    contourf(zeta2D, alpha2D, BHat_sup_theta, numContours, 'EdgeColor','none')
    colorbar
    xlabel('\alpha')
    ylabel('\zeta')
    ...
    subplot(numRows,numCols,plotNum); plotNum = plotNum + 1;
    contourf(zeta2D, alpha2D, BHat_sup_zeta, numContours, 'EdgeColor','none')
    colorbar
    xlabel('\alpha')
    ylabel('\zeta')
    ...
    subplot(numRows,numCols,plotNum); plotNum = plotNum + 1;
    contourf(zeta2D, alpha2D, DHat, numContours, 'EdgeColor','none')
    colorbar
    xlabel('\alpha')
    ylabel('\zeta')
    ...
    subplot(numRows,numCols,plotNum); plotNum = plotNum + 1;
    contourf(zeta2D, alpha2D, BHat_sub_psi, numContours, 'EdgeColor','none')
    colorbar
    xlabel('\alpha')
    ylabel('\zeta')
    ...
    subplot(numRows,numCols,plotNum); plotNum = plotNum + 1;
    contourf(zeta2D, alpha2D, BHat_sub_theta, numContours, 'EdgeColor','none')
    colorbar
    xlabel('\alpha')
    ylabel('\zeta')
    ...
    subplot(numRows,numCols,plotNum); plotNum = plotNum + 1;
    contourf(zeta2D, alpha2D, BHat_sub_zeta, numContours, 'EdgeColor','none')
    colorbar
    xlabel('\alpha')
    ylabel('\zeta')
    ...
    subplot(numRows,numCols,plotNum); plotNum = plotNum + 1;
    contourf(zeta2D, alpha2D, dBHat_sub_psi_dtheta, numContours, 'EdgeColor','none')
    colorbar
    xlabel('\alpha')
    ylabel('\zeta')
    ...
    subplot(numRows,numCols,plotNum); plotNum = plotNum + 1;
    contourf(zeta2D, alpha2D, dBHat_sub_psi_dzeta, numContours, 'EdgeColor','none')
    colorbar
    xlabel('\alpha')
    ylabel('\zeta')
    ...
    subplot(numRows,numCols,plotNum); plotNum = plotNum + 1;
    contourf(zeta2D, alpha2D, dBHat_sub_theta_dpsiHat, numContours, 'EdgeColor','none')
    colorbar
    xlabel('\alpha')
    ylabel('\zeta')
    ...
    subplot(numRows,numCols,plotNum); plotNum = plotNum + 1;
    contourf(zeta2D, alpha2D, dBHat_sub_theta_dzeta, numContours, 'EdgeColor','none')
    colorbar
    xlabel('\alpha')
    ylabel('\zeta')
    ...
    subplot(numRows,numCols,plotNum); plotNum = plotNum + 1;
    contourf(zeta2D, alpha2D, dBHat_sub_zeta_dpsiHat, numContours, 'EdgeColor','none')
    colorbar
    xlabel('\alpha')
    ylabel('\zeta')
    ...
    subplot(numRows,numCols,plotNum); plotNum = plotNum + 1;
    contourf(zeta2D, alpha2D, dBHat_sub_zeta_dtheta, numContours, 'EdgeColor','none')
    colorbar
    xlabel('\alpha')
    ylabel('\zeta')
    ...
    subplot(numRows,numCols,plotNum); plotNum = plotNum + 1;
    contourf(zeta2D, alpha2D, dBHatdpsiHat, numContours, 'EdgeColor','none')
    colorbar
    xlabel('\alpha')
    ylabel('\zeta')
    ...
    subplot(numRows,numCols,plotNum); plotNum = plotNum + 1;
    contourf(zeta2D, alpha2D, dBHatdtheta, numContours, 'EdgeColor','none')
    colorbar
    xlabel('\alpha')
    ylabel('\zeta')
    ...
    subplot(numRows,numCols,plotNum); plotNum = plotNum + 1;
    contourf(zeta2D, alpha2D, dBHatdzeta, numContours, 'EdgeColor','none')
    colorbar
    xlabel('\alpha')
    ylabel('\zeta')
    ...
    contourf(zeta2D, alpha2D, data, numContours, 'EdgeColor','none')
    colorbar
    xlabel('\alpha')
    ylabel('\zeta')
    ...
    subplot(numRows,numCols,plotNum); plotNum = plotNum + 1;
    contourf(zeta2D, alpha2D, BDotCurlB, numContours, 'EdgeColor','none')
    colorbar
    xlabel('\alpha')
    ylabel('\zeta')
