...
{real}
{1.0}
{\todo{Whenever \parlink{RHSMode} == 1 and \parlink{withNBIspec} == \true}}
{\todo{Charge of NBI heated species, in units of the proton charge $e$.}}
...
{0.0}
{\todo{Whenever \parlink{RHSMode} == 1 and \parlink{withNBIspec} == \true}}
{\todo{Density of NBI heated species, in units of the reference density $\bar{n}$.}}
