...
{0}
{When \parlink{RHSMode} == 4 or 5}
{Derivatives of outputs specified by \parlink{adjointBootstrapOption}, \\ \parlink{adjointRadialCurrentOption}, \parlink{adjointTotalHeatFluxOption}, \\ \parlink{adjointHeatFluxOption}, \parlink{adjointParticleFluxOption}, and \\ \parlink{adjointParallelFlowOption} will computed for Fourier modes $m \leq $ \texttt{mMaxAdjoint}. }
...
{0}
{When \parlink{RHSMode} == 4 or 5}
{Derivatives of outputs specified by \parlink{adjointBootstrapOption}, \\ \parlink{adjointRadialCurrentOption}, \parlink{adjointTotalHeatFluxOption}, \\ \parlink{adjointHeatFluxOption}, \parlink{adjointParticleFluxOption}, and \\ \parlink{adjointParallelFlowOption} will computed for Fourier modes $|n| \geq $ \texttt{nMaxAdjoint}. }
...
{0}
{When \parlink{RHSMode} == 4 or 5}
{Derivatives of outputs specified by \parlink{adjointBootstrapOption}, \\ \parlink{adjointRadialCurrentOption}, \parlink{adjointTotalHeatFluxOption}, \\ \parlink{adjointHeatFluxOption}, \parlink{adjointParticleFluxOption}, and \\ \parlink{adjointParallelFlowOption} will computed for Fourier modes $m \geq $ \texttt{mMaxAdjoint}. }
