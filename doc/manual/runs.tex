...
and therefore increase the memory required for factorization; a typical increase is 20-40\%.
These magnetic drift terms typically have a minor effect except when the radial
