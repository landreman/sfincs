...
and \parlink{zetaDerivativeScheme}.\\

{\ttfamily ExBDerivativeScheme} = 0: Use same differentiation matrices as for the parallel streaming term.  This option is best except for very
large radial electric fields, when the electric field is as large as the resonance or larger.\\
