...
{The derivative of the electrostatic potential with respect to the radial coordinate $\hat{r}$, multiplied by $-1$,
i.e. the radial electric field.
Notice that exactly 1 of the 5 variables \parlink{dPhiHatdpsiHat}, \parlink{dPhiHatdpsiN}, \parlink{dPhiHatdrHat}, \parlink{dPhiHatdrN}, or \parlink{Er}
will be used, depending on\\
\parlink{inputRadialCoordinateForGradients}.
}
...
and \parlink{zetaDerivativeScheme}, and are analogous to the options for \parlink{ExBDerivativeScheme}.
