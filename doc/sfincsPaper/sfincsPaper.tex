...
First, when $E_r \ne 0$, the sources are needed to eliminate the conservation problems, and the extra constraints then keep the linear system square (number of equations = number of unknowns) upon discretizatiton.
...
trajectory models.
\changed{
The ion particle and heat sources in (D)-(E) are normalized
