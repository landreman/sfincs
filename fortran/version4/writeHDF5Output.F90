...
contains
  ...
  subroutine initializeOutputFile()
    ...
    if (masterProc) then
       ...
       call writeHDF5Field("ddtheta_plus", ddtheta_plus, dspaceIDforThetaTheta, dimForThetaTheta, "")
       call writeHDF5Field("ddtheta_minus", ddtheta_minus, dspaceIDforThetaTheta, dimForThetaTheta, "")
       call writeHDF5Field("ddtheta_plus_preconditioner", ddtheta_plus_preconditioner, dspaceIDforThetaTheta, dimForThetaTheta, "")
       call writeHDF5Field("ddtheta_minus_preconditioner", ddtheta_minus_preconditioner, dspaceIDforThetaTheta, dimForThetaTheta, "")
