...
!!        nonlinear = .false. !!Commented by AM 2016-02
  ...
  if (saveMatlabOutput .and. Nspecies*(NFourier*2-1)*Nxi*Nx > 5000 .and. masterProc) then
     print *,line
     print *,line
...
!!$  end if 
  ...
  if ((NFourier*2-1)*Nx*Nxi*Nspecies > 1e7 .and. masterProc) then
     print *,line
     print *,line
     print *,"**   WARNING: You have selected large resolution parameters, leading to a matrix size"
     print *,"**            exceeding 10 million x 10 million.  It will take quite a lot of memory to run"
  ...
  if (NFourier<1) then
     if (masterProc) then
        print *,"Error! NFourier must be at least 1."
     end if
     stop
  end if

  if (NFourier > 10000 .and. masterProc) then
     print *,line
     print *,line
     print *,"**   WARNING: You chose a very large value for NFourier."
     print *,line
     print *,line
  end if
  ...
  if (mmax > 256 .and. masterProc) then
     print *,line
     print *,line
     print *,"**   WARNING: You chose a very large value for mmax."
     print *,line
     print *,line
  end if
  ...
  if (nmax<0) then
     if (masterProc) then
        print *,"Error! nmax must be at least 0."
     end if
     stop
  end if

  if (nmax > 256 .and. masterProc) then
     print *,line
     print *,line
     print *,"**   WARNING: You chose a very large value for nmax."
     print *,line
     print *,line
  end if
