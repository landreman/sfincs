...
contains
  ...
  subroutine initializeOutputFile()
    ...
    if (masterProc) then
       ...
       call writeHDF5Field("d(PhiHat)d(psiHat)", dPhiHatdpsiHat)
       call writeHDF5Field("d(PhiHat)d(psi_N)", dPhiHatdpsiN)
       call writeHDF5Field("d(PhiHat)d(rHat)", dPhiHatdrHat)
       call writeHDF5Field("d(PhiHat)d(r_N)", dPhiHatdrN)

       call writeHDF5Field("d(THat)d(psiHat)", dTHatdpsiHats, dspaceIDForSpecies, dimForSpecies)
       call writeHDF5Field("d(THat)d(psi_N)", dTHatdpsiNs, dspaceIDForSpecies, dimForSpecies)
       call writeHDF5Field("d(THat)d(rHat)", dTHatdrHats, dspaceIDForSpecies, dimForSpecies)
       call writeHDF5Field("d(THat)d(r_N)", dTHatdrNs, dspaceIDForSpecies, dimForSpecies)

       call writeHDF5Field("d(nHat)d(psiHat)", dnHatdpsiHats, dspaceIDForSpecies, dimForSpecies)
       call writeHDF5Field("d(nHat)d(psi_N)", dnHatdpsiNs, dspaceIDForSpecies, dimForSpecies)
       call writeHDF5Field("d(nHat)d(rHat)", dnHatdrHats, dspaceIDForSpecies, dimForSpecies)
       call writeHDF5Field("d(nHat)d(r_N)", dnHatdrNs, dspaceIDForSpecies, dimForSpecies)
