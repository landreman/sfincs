...
numFailures += shouldBe("particleFlux_vd_psiHat[0,0;;;]", -2.145587846683186E-006, desiredTolerance)
numFailures += shouldBe("heatFlux_vd_psiHat[0,0;;;]", -1.801092374929527E-004, desiredTolerance)
...
numFailures += shouldBe("particleFlux_vd_psiHat[1,0;;;]", -2.081637115299071E-005, desiredTolerance)
numFailures += shouldBe("heatFlux_vd_psiHat[1,0;;;]", -4.445459659182958E-002, desiredTolerance)
