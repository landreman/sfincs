...
numFailures += shouldBe("particleFlux_vd_psiHat[0,0;;;]", -1.116826148932465E-006, desiredTolerance)
numFailures += shouldBe("heatFlux_vd_psiHat[0,0;;;]", -2.382995682114280E-006, desiredTolerance)
...
numFailures += shouldBe("particleFlux_vd_psiHat[1,0;;;]", -5.480946026266353E-008, desiredTolerance)
numFailures += shouldBe("heatFlux_vd_psiHat[1,0;;;]", -1.133473454775712E-007, desiredTolerance)
