...
numFailures += shouldBe("particleFlux_vd_psiHat[1,0;;;]", 9.012860128087754E-011, desiredTolerance)
numFailures += shouldBe("heatFlux_vd_psiHat[1,0;;;]", 2.007511670631882E-011, desiredTolerance)
