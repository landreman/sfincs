...
numFailures += shouldBe("particleFlux_vd_psiHat[0,0;;;]", -1.078924587797651E-006, desiredTolerance)
numFailures += shouldBe("heatFlux_vd_psiHat[0,0;;;]", -2.337320329279748E-006, desiredTolerance)
...
numFailures += shouldBe("particleFlux_vd_psiHat[1,0;;;]", -5.355677905882999E-008, desiredTolerance)
numFailures += shouldBe("heatFlux_vd_psiHat[1,0;;;]", -1.075782052474404E-007, desiredTolerance)
