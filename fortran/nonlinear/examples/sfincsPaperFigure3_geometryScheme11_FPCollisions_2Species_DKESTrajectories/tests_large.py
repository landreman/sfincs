...
numFailures += shouldBe("particleFlux_vd_psiHat[0,0;;;]", -1.110019018426244E-006, desiredTolerance)
numFailures += shouldBe("heatFlux_vd_psiHat[0,0;;;]", -2.419159180052273E-006, desiredTolerance)
...
numFailures += shouldBe("particleFlux_vd_psiHat[1,0;;;]", -5.357759543503480E-008, desiredTolerance)
numFailures += shouldBe("heatFlux_vd_psiHat[1,0;;;]", -1.076434969068456E-007, desiredTolerance)
