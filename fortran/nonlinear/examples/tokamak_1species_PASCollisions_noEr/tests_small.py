...
numFailures += shouldBe("particleFlux_vd_psiHat[0,0;;;]", 2.43400486962836789E-007, desiredTolerance)
numFailures += shouldBe("heatFlux_vd_psiHat[0,0;;;]", 1.78992270500802452E-007, desiredTolerance)
