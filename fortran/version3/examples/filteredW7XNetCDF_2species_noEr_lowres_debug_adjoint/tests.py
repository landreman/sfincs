...
numFailures += shouldBe("dParallelFlowdLambda[3,0,0,0;;;]", -0.0386585, desiredTolerance)
...
numFailures += shouldBe("dParallelFlowdLambda[0,0,1,0;;;]", -9.47519e-05, desiredTolerance)
