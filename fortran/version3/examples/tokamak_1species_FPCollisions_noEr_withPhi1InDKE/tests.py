...
numFailures += shouldBe("particleFlux_vd1_psiHat[0,2;;;]",  6.88694336331440671E-011, easyTolerance)
numFailures += shouldBe("particleFlux_vd_psiHat[0,2;;;]",   6.88694336330911275E-011, easyTolerance)
