subroutine sfincs_finalize()
  ...
  if(allocated(full_f))deallocate(full_f)
	...
	if(allocated(dradialcurrentdlambda))deallocate(dradialcurrentdlambda)
	if(allocated(dtotalheatfluxdlambda))deallocate(dtotalheatfluxdlambda)
	if(allocated(dbootstrapdlambda))deallocate(dbootstrapdlambda)
	if(allocated(dheatfluxdlambda))deallocate(dheatfluxdlambda)
	if(allocated(dparticlefluxdlambda))deallocate(dparticlefluxdlambda)
	if(allocated(dparallelflowdlambda))deallocate(dparallelflowdlambda)
	if(allocated(adjointheatfluxoption))deallocate(adjointheatfluxoption)
	if(allocated(adjointparticlefluxoption))deallocate(adjointparticlefluxoption)
	if(allocated(adjointparallelflowoption))deallocate(adjointparallelflowoption)
