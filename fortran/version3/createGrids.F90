...
!!$       end do
    ...
    allocate(classicalHeatFlux_psiHat(Nspecies))
    allocate(classicalHeatFluxNoPhi1_psiHat(Nspecies))
    allocate(classicalHeatFlux_psiN(Nspecies))
    allocate(classicalHeatFluxNoPhi1_psiN(Nspecies))
    allocate(classicalHeatFlux_rHat(Nspecies))
    allocate(classicalHeatFluxNoPhi1_rHat(Nspecies))
    allocate(classicalHeatFlux_rN(Nspecies))
    allocate(classicalHeatFluxNoPhi1_rN(Nspecies))
