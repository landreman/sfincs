...
!!            "Include term $(\vect{v}_{E} \cdot\nabla\psi)f_{Ms} [(1/n_s)(dn_s/d\psi) + (x_s^2-3/2)(1/T_s)(dT_s/d\psi)]$ term? " // boolDescription) !!Commented by AM 2016-03
  ...
  subroutine updateOutputFile(iterationNum, writeTransportMatrix)
    ...
    if (masterProc) then
       ...
       call writeHDF5ExtensibleField(iterationNum, "classicalHeatFlux_psiN", classicalHeatFlux_psiN, ARRAY_ITERATION_SPECIES, "")
       call writeHDF5ExtensibleField(iterationNum, "classicalHeatFlux_rHat", classicalHeatFlux_rHat, ARRAY_ITERATION_SPECIES, "")
       call writeHDF5ExtensibleField(iterationNum, "classicalHeatFlux_rN", classicalHeatFlux_rN, ARRAY_ITERATION_SPECIES, "")
