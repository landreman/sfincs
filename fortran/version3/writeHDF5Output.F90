...
contains
  ...
  subroutine initializeOutputFile()
    ...
    call writeHDF5Field("NBIspecNHat", NBIspecNHat, "Flux surface averaged density of the NBI species, in units of nBar.")
       ...
       !!Added by SB 2018-05!!
       call writeHDF5Field("classicalParticleFluxNoPhi1_psiHat", classicalParticleFluxNoPhi1_psiHat, dspaceIDForSpecies, dimForSpecies, "Classical particle flux projected onto \nabla psiHat, calculcated with Phi1 = 0.")
       ...
       !!Added by SB 2019-01!!
       call writeHDF5Field("classicalHeatFluxNoPhi1_psiHat", classicalHeatFluxNoPhi1_psiHat, dspaceIDForSpecies, dimForSpecies, "Classical heat flux projected onto \nabla psiHat, calculcated with Phi1 = 0. Updated with correct normalization: 2019-03-08.")
    ...
    if (masterProc) then
     ...
     ! Over-write prevoius value for Er
      ...
      call h5dclose_f(dsetID, HDF5Error)
       ...
       call writeHDF5ExtensibleField(iterationNum, "adjointParticleFlux_vm0_rHat", adjointParticleFlux_vm0_rHat, ARRAY_ITERATION_SPECIES, "")
       ...
       call writeHDF5ExtensibleField(iterationNum, "classicalParticleFlux_psiHat", classicalParticleFlux_psiHat, ARRAY_ITERATION_SPECIES, "")
       call writeHDF5ExtensibleField(iterationNum, "classicalParticleFlux_psiN", classicalParticleFlux_psiN, ARRAY_ITERATION_SPECIES, "")
       call writeHDF5ExtensibleField(iterationNum, "classicalParticleFlux_rHat", classicalParticleFlux_rHat, ARRAY_ITERATION_SPECIES, "")
       call writeHDF5ExtensibleField(iterationNum, "classicalParticleFlux_rN", classicalParticleFlux_rN, ARRAY_ITERATION_SPECIES, "")
       call writeHDF5ExtensibleField(iterationNum, "classicalHeatFlux_psiHat", classicalHeatFlux_psiHat, ARRAY_ITERATION_SPECIES, "Updated with correct normalization 2019-03-08.")
       call writeHDF5ExtensibleField(iterationNum, "classicalHeatFlux_psiN", classicalHeatFlux_psiN, ARRAY_ITERATION_SPECIES, "Updated with correct normalization 2019-03-08.")
       call writeHDF5ExtensibleField(iterationNum, "classicalHeatFlux_rHat", classicalHeatFlux_rHat, ARRAY_ITERATION_SPECIES, "Updated with correct normalization 2019-03-08.")
       call writeHDF5ExtensibleField(iterationNum, "classicalHeatFlux_rN", classicalHeatFlux_rN, ARRAY_ITERATION_SPECIES, "Updated with correct normalization 2019-03-08")
