...
!!    if (isAParallelDirectSolverInstalled .and. (whichParallelSolverToFactorPreconditioner==1)) then
         ...
         ! CNTL(1) is a threshhol .and. mumps_icntl_14<1024d for pivoting. For the default value of 0.01, there is a lot of pivoting.
        ...
        ! Syntax for PETSc versions up through 3.4
         ...
         if (masterProc) then
            print *,"MatMumpsSetIcntl mumps_which_cntl: ",mumps_which_cntl
            print *,"MatMumpsSetIcntl mumps_icntl_14: ",mumps_icntl_14
            print *,"MatMumpsSetIcntl ierr: ",ierr
         end if

         call MatMumpsGetIcntl(factorMat,mumps_which_cntl,info,ierr)
         if (masterProc) then
            print *,"MatMumpsGetIcntl Icntl: ",info
         end if
#endif
      end if
      ...
      case (1)
         ...
         if (solveSystem) then
            ...
            call MatMumpsGetInfo(factorMat, 1, info)
            print *,"info MatMumpsGetInfo=",info
            if (actualSolverPackage == MATSOLVERMUMPS .and. info .ne. 0 .and. mumps_icntl_14<1024) then
