             ...
             do izeta=izetaMin,izetaMax
                ...
                do ix=max(ixMin,min_x_for_L(L)),Nx
                   do itheta=1,localNtheta
                      rowIndices(itheta) = getIndex(ispecies, ix, L+1, ithetaMin+itheta-1, izeta, BLOCK_F,whichMatrix)
                   end do
             ...
             do itheta=ithetaMin, ithetaMax
                ...
                do ix=max(ixMin,min_x_for_L(L)),Nx
                   do izeta = 1,localNzeta
                      rowIndices(izeta)=getIndex(ispecies, ix, L+1, itheta, izetaMin+izeta-1, BLOCK_F, whichMatrix)
                   end do
       ...
       if (whichMatrix .ne. 2) then
          ...
          do L=0,(Nxi-1)
             ...
             do izeta=izetaMin,izetaMax
                ...
                do ix=max(ixMin,min_x_for_L(L)),Nx
                   do itheta=1,localNtheta
                      rowIndices(itheta)=getIndex(ispecies,ix,L+1,itheta+ithetaMin-1,izeta,BLOCK_F,whichMatrix)
                   end do
                   do itheta=1,Ntheta
       ...
       if (whichMatrix .ne. 2) then
          ...
          do L=0,(Nxi-1)
             ...
             do itheta=ithetaMin, ithetaMax
                ...
                do ix=max(ixMin,min_x_for_L(L)),Nx
                   do izeta=1,localNzeta
                      rowIndices(izeta)=getIndex(ispecies,ix,L+1,itheta,izeta+izetaMin-1,BLOCK_F,whichMatrix)
                   end do
                   do izeta=1,Nzeta
...
!!                                     call MatSetValue(matrix, rowIndex, colIndex, & 
                               ...
                               if (whichMatrix == 1 .or. whichMatrix == 0) then ! Jacobian or Preconditioner
                                  ...
                                  do ix= max(ixMinCol,min_x_for_L(L)),Nx
                                     ...
                                     index = getIndex(iSpeciesB,ix,L+1,itheta,izeta,BLOCK_F,whichMatrix)
