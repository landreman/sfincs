...
#include <petsc/finclude/petscsysdef.h>
  ...
  integer(HSIZE_T), dimension(3) :: dimForIterationAlphaZeta
  integer(HSIZE_T), dimension(3) :: maxDimForIterationAlphaZeta
  integer(HSIZE_T), dimension(3) :: dimForIterationAlphaZetaChunk
  integer(HID_T) :: pForIterationAlphaZeta
  integer(HID_T) :: dspaceIDForIterationAlphaZeta
  ...
  integer(HSIZE_T), dimension(4) :: dimForIterationSpeciesAlphaZeta
  integer(HSIZE_T), dimension(4) :: maxDimForIterationSpeciesAlphaZeta
  integer(HSIZE_T), dimension(4) :: dimForIterationSpeciesAlphaZetaChunk
  integer(HID_T) :: pForIterationSpeciesAlphaZeta
  integer(HID_T) :: dspaceIDForIterationSpeciesAlphaZeta
  ...
  integer, parameter :: ARRAY_ITERATION_ALPHA_ZETA = 102
  integer, parameter :: ARRAY_ITERATION_SPECIES_ALPHA_ZETA = 103
...
contains
  ...
  subroutine initializeOutputFile()
    ...
    if (masterProc) then
       ...
       call writeHDF5Field("Nalpha", Nalpha, "Number of grid points in the field line label coordinate alpha")
       ...
       call writeHDF5Field("alpha", alpha, dspaceIDForAlpha, dimForAlpha, &
            "Grid points in the field line label coordinate, which runs from 0 to 2pi")
       ...
       call writeHDF5Field("streaming_theta_derivative_option", streaming_theta_derivative_option, "")
       call writeHDF5Field("preconditioner_streaming_theta_derivative_option", preconditioner_streaming_theta_derivative_option, "")
       call writeHDF5Field("preconditioner_streaming_theta_min_L", preconditioner_streaming_theta_min_L, "")
       call writeHDF5Field("streaming_zeta_derivative_option", streaming_zeta_derivative_option, "")
       call writeHDF5Field("preconditioner_streaming_zeta_derivative_option", preconditioner_streaming_zeta_derivative_option, "")
       call writeHDF5Field("preconditioner_streaming_zeta_min_L", preconditioner_streaming_zeta_min_L, "")
       call writeHDF5Field("ExB_alpha_derivative_option", ExB_alpha_derivative_option, "")
       call writeHDF5Field("preconditioner_ExB_alpha_derivative_option", preconditioner_ExB_alpha_derivative_option, "")
       call writeHDF5Field("preconditioner_ExB_alpha_min_L", preconditioner_ExB_alpha_min_L, "")
       call writeHDF5Field("ExB_zeta_derivative_option", ExB_zeta_derivative_option, "")
       call writeHDF5Field("preconditioner_ExB_zeta_derivative_option", preconditioner_ExB_zeta_derivative_option, "")
       call writeHDF5Field("preconditioner_ExB_zeta_min_L", preconditioner_ExB_zeta_min_L, "")
       call writeHDF5Field("alpha_interpolation_stencil", alpha_interpolation_stencil, "")
       ...
       call writeHDF5Field("DHat", DHat, dspaceIDForAlphaZeta, dimForAlphaZeta, &
            "Inverse Jacobian (grad psi dot grad alpha cross grad zeta, where 2*pi*psi is the toroidal flux), in units of BBar / RBar")
       call writeHDF5Field("BHat", BHat, dspaceIDForAlphaZeta, dimForAlphaZeta, &
            "Magnitude of the magnetic field, in units of BBar")
       call writeHDF5Field("dBHatdpsiHat", dBHatdpsiHat, dspaceIDForAlphaZeta, dimForAlphaZeta, "")
       call writeHDF5Field("dBHatdtheta", dBHatdtheta, dspaceIDForAlphaZeta, dimForAlphaZeta, "")
       call writeHDF5Field("dBHatdzeta", dBHatdzeta, dspaceIDForAlphaZeta, dimForAlphaZeta, "")
       call writeHDF5Field("BDotCurlB", BDotCurlB, dspaceIDForAlphaZeta, dimForAlphaZeta, &
            "\vect{B}\cdot\nabla\times\vect{B}, in units of BBar^2 / RBar")
       call writeHDF5Field("uHat", uHat, dspaceIDForAlphaZeta, dimForAlphaZeta, &
            "\nabla_\parallel u = (2/B^4)\nabla B\times\vector{B}\cdot\iota\nabla\psi")

       call writeHDF5Field("BHat_sub_psi", BHat_sub_psi, dspaceIDForAlphaZeta, dimForAlphaZeta, &
            "Covariant component of B, the component that multiplies grad psi, in units of 1 / RBar")
       call writeHDF5Field("dBHat_sub_psi_dtheta", dBHat_sub_psi_dtheta, dspaceIDForAlphaZeta, dimForAlphaZeta, "")
       call writeHDF5Field("dBHat_sub_psi_dzeta", dBHat_sub_psi_dzeta, dspaceIDForAlphaZeta, dimForAlphaZeta, "")

       call writeHDF5Field("BHat_sub_theta", BHat_sub_theta, dspaceIDForAlphaZeta, dimForAlphaZeta, &
            "Covariant component of B, the component that multiplies grad theta, in units of BBar * RBar")
       call writeHDF5Field("dBHat_sub_theta_dpsiHat", dBHat_sub_theta_dpsiHat, dspaceIDForAlphaZeta, dimForAlphaZeta, "")
       call writeHDF5Field("dBHat_sub_theta_dzeta", dBHat_sub_theta_dzeta, dspaceIDForAlphaZeta, dimForAlphaZeta, "")

       call writeHDF5Field("BHat_sub_zeta", BHat_sub_zeta, dspaceIDForAlphaZeta, dimForAlphaZeta, &
            "Covariant component of B, the component that multiplies grad zeta, in units of BBar * RBar")
       call writeHDF5Field("dBHat_sub_zeta_dpsiHat", dBHat_sub_zeta_dpsiHat, dspaceIDForAlphaZeta, dimForAlphaZeta, "")
       call writeHDF5Field("dBHat_sub_zeta_dtheta", dBHat_sub_zeta_dtheta, dspaceIDForAlphaZeta, dimForAlphaZeta, "")

       call writeHDF5Field("BHat_sup_theta", BHat_sup_theta, dspaceIDForAlphaZeta, dimForAlphaZeta, &
            "Contravariant component of B, the component that multiplies d r / d theta, in units of BBar / RBar")
       call writeHDF5Field("dBHat_sup_theta_dpsiHat", dBHat_sup_theta_dpsiHat, dspaceIDForAlphaZeta, dimForAlphaZeta, "")
       call writeHDF5Field("dBHat_sup_theta_dzeta", dBHat_sup_theta_dzeta, dspaceIDForAlphaZeta, dimForAlphaZeta, "")

       call writeHDF5Field("BHat_sup_zeta", BHat_sup_zeta, dspaceIDForAlphaZeta, dimForAlphaZeta, &
            "Contravariant component of B, the component that multiplies d r / d zeta, in units of BBar / RBar")
       call writeHDF5Field("dBHat_sup_zeta_dpsiHat", dBHat_sup_zeta_dpsiHat, dspaceIDForAlphaZeta, dimForAlphaZeta, "")
       call writeHDF5Field("dBHat_sup_zeta_dtheta", dBHat_sup_zeta_dtheta, dspaceIDForAlphaZeta, dimForAlphaZeta, "")
       ...
       call writeHDF5Field("gamma", gamma, "Dimensionless combination of the normalization constants: gamma = e * PhiBar / TBar.")
...
! export_f has not yet been updated to reflect the new alpha coordinate
...
!!$       call h5sclose_f(dspaceIDForExport_f_x, HDF5Error)
  ...
  subroutine updateOutputFile(iterationNum, writeTransportMatrix)
    ...
    if (masterProc) then
       ...
       dimForIterationAlphaZeta(1) = iterationNum
       dimForIterationSpeciesAlphaZeta(1) = iterationNum
       ...
       call writeHDF5ExtensibleField(iterationNum, "densityPerturbation", densityPerturbation, &
            ARRAY_ITERATION_SPECIES_ALPHA_ZETA, &
       ...
       call writeHDF5ExtensibleField(iterationNum, "jHat", jHat, ARRAY_ITERATION_ALPHA_ZETA, &
       ...
       if (includePhi1) then
          call writeHDF5ExtensibleField(iterationNum, "Phi1Hat", Phi1Hat, ARRAY_ITERATION_ALPHA_ZETA, &
               "Electrostatic potential Phi minus its flux-surface-average, in units of PhiBar")
          call writeHDF5ExtensibleField(iterationNum, "dPhi1Hatdalpha", dPhi1Hatdalpha, ARRAY_ITERATION_ALPHA_ZETA, &
               "Derivative of Phi_1 with respect to alpha. Phi_1 = Electrostatic potential Phi minus its flux-surface-average, in units of PhiBar." //&
               "alpha = field line label")
          call writeHDF5ExtensibleField(iterationNum, "dPhi1Hatdzeta", dPhi1Hatdzeta, ARRAY_ITERATION_ALPHA_ZETA,  &
...
!!$
  ...
  subroutine createHDF5Structures()
    ...
    dimForAlpha = Nalpha
    call h5screate_simple_f(rank, dimForAlpha, dspaceIDForAlpha, HDF5Error)
...
!!$    call h5screate_simple_f(rank, dimForExport_f, dspaceIDForExport_f, HDF5Error)
    ...
    rank = 3
    dimForIterationAlphaZeta(1)      = 1
    maxDimForIterationAlphaZeta(1)   = H5S_UNLIMITED_F
    dimForIterationAlphaZetaChunk(1) = 1

    dimForIterationAlphaZeta(2)      = Nalpha
    maxDimForIterationAlphaZeta(2)   = Nalpha
    dimForIterationAlphaZetaChunk(2) = Nalpha

    dimForIterationAlphaZeta(3)      = Nzeta
    maxDimForIterationAlphaZeta(3)   = Nzeta
    dimForIterationAlphaZetaChunk(3) = Nzeta

    call h5screate_simple_f(rank, dimForIterationAlphaZeta, dspaceIDForIterationAlphaZeta, &
         HDF5Error, maxDimForIterationAlphaZeta)
    call h5pcreate_f(H5P_DATASET_CREATE_F, pForIterationAlphaZeta, HDF5Error)
    call h5pset_chunk_f(pForIterationAlphaZeta, rank, dimForIterationAlphaZetaChunk, HDF5Error)
    ...
    rank = 4
    dimForIterationSpeciesAlphaZeta(1)      = 1
    maxDimForIterationSpeciesAlphaZeta(1)   = H5S_UNLIMITED_F
    dimForIterationSpeciesAlphaZetaChunk(1) = 1

    dimForIterationSpeciesAlphaZeta(2)      = Nspecies
    maxDimForIterationSpeciesAlphaZeta(2)   = Nspecies
    dimForIterationSpeciesAlphaZetaChunk(2) = Nspecies

    dimForIterationSpeciesAlphaZeta(3)      = Nalpha
    maxDimForIterationSpeciesAlphaZeta(3)   = Nalpha
    dimForIterationSpeciesAlphaZetaChunk(3) = Nalpha

    dimForIterationSpeciesAlphaZeta(4)      = Nzeta
    maxDimForIterationSpeciesAlphaZeta(4)   = Nzeta
    dimForIterationSpeciesAlphaZetaChunk(4) = Nzeta

    call h5screate_simple_f(rank, dimForIterationSpeciesAlphaZeta, dspaceIDForIterationSpeciesAlphaZeta, &
         HDF5Error, maxDimForIterationSpeciesAlphaZeta)
    call h5pcreate_f(H5P_DATASET_CREATE_F, pForIterationSpeciesAlphaZeta, HDF5Error)
    call h5pset_chunk_f(pForIterationSpeciesAlphaZeta, rank, dimForIterationSpeciesAlphaZetaChunk, HDF5Error)
...
!!$    call h5pset_chunk_f(pForExport_f, rank, dimForExport_fChunk, HDF5Error)
  ...
  subroutine finalizeHDF5()
    ...
    if (masterProc) then
       ...
       call h5pclose_f(pForIterationSpeciesAlphaZeta, HDF5Error)
       call h5pclose_f(pForIterationAlphaZeta, HDF5Error)
...
#define maxInputFileSize 99999
  ...
  subroutine writeHDF5Doubles(arrayName, data, dspaceID, dims, description)
    ...
    elseif (dspaceID == dspaceIDForAlpha) then
...
!!$       call h5dsset_label_f(dsetID, 4, "export_f_alpha", HDF5Error)
...
!!$  end subroutine writeHDF5Doubles5
  ...
  subroutine writeHDF5ExtensibleField3(iterationNum, arrayName, data, arrayType, description)
    ...
    select case (arrayType)
    case (ARRAY_ITERATION_ALPHA_ZETA)
       originalDspaceID = dspaceIDForIterationAlphaZeta
       dim = dimForIterationAlphaZeta
       dimForChunk = dimForIterationAlphaZetaChunk
       chunkProperties = pForIterationAlphaZeta
       label1 = "zeta"
       label2 = "alpha"
       label3 = "iteration"
  ...
  subroutine writeHDF5ExtensibleField4(iterationNum, arrayName, data, arrayType, description)
    ...
    select case (arrayType)
    case (ARRAY_ITERATION_SPECIES_ALPHA_ZETA)
       originalDspaceID = dspaceIDForIterationSpeciesAlphaZeta
       dim = dimForIterationSpeciesAlphaZeta
       dimForChunk = dimForIterationSpeciesAlphaZetaChunk
       chunkProperties = pForIterationSpeciesAlphaZeta
