...
contains
  ...
  subroutine initializeOutputFile()
    ...
    if (masterProc) then
       ...
       call writeHDF5Field("alphaDerivativeScheme", alphaDerivativeScheme, "")
       ...
       call writeHDF5Field("ExBDerivativeSchemeAlpha", ExBDerivativeSchemeAlpha, "")
       ...
       call writeHDF5Field("preconditioner_alpha", preconditioner_alpha, "")
