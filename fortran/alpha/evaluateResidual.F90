...
!!    PetscScalar :: scalar, xPartOfRHS, factor !!Commented by AM 2016-03
    ...
    integer :: ix, L, ialpha, izeta, ispecies, index
    ...
    do ispecies = 1,Nspecies
       ...
       do ix=ixMin,Nx
          ...
          !     + gamma*Zs(ispecies)/THats(ispecies)*dPhiHatdpsiNToUse &
          ...
          do ialpha = ialphaMin,ialphaMax
             do izeta = izetaMinDKE,izetaMaxDKE
                ...
                !     /(2*pi*sqrtpi*Zs(ispecies)*psiAHat*(BHat(ialpha,izeta)**3)*sqrtTHat) &
