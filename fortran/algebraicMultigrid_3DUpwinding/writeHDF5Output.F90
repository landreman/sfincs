...
contains
  ...
  subroutine initializeOutputFile()
    ...
    if (masterProc) then
       ...
       call writeHDF5Field("xi_weights", xi_weights, dspaceIDForXi, dimForXi, &
       ...
       call writeHDF5Field("first_derivative_option", first_derivative_option, "")
       call writeHDF5Field("second_derivative_option", second_derivative_option, "")
       ...
       call writeHDF5Field("preconditioner_first_derivative_option", preconditioner_first_derivative_option, "")
       call writeHDF5Field("preconditioner_second_derivative_option", preconditioner_second_derivative_option, "")
