...
!!  logical :: includeRadialExBDrive = .false. !!Commented by AM 2016-02
  ...
  integer :: first_derivative_option = 501
  ...
  integer :: preconditioner_first_derivative_option = 101
  integer :: preconditioner_second_derivative_option = 2
  ...
  real(prec), dimension(-stencil_width:stencil_width) :: first_derivative_stencil, first_derivative_stencil_preconditioner
  real(prec), dimension(-stencil_width:stencil_width) :: second_derivative_stencil, second_derivative_stencil_preconditioner
  real(prec) :: dtheta, dzeta, dalpha
  integer, dimension(:), allocatable :: Nxi_for_x, min_x_for_L
  integer :: matrixSize, NxPotentials
  real(prec), dimension(:), allocatable :: theta, zeta, x, x_plus1, xi, sin_alpha
  real(prec) :: theta_weight, zeta_weight
  real(prec), dimension(:), allocatable :: xi_weights
