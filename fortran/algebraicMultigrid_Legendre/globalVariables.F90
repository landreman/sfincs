...
!!  logical :: includeRadialExBDrive = .false. !!Commented by AM 2016-02
  ...
  real(prec), dimension(:,:), allocatable, target :: ddtheta_sum, ddtheta_difference, ddtheta_sum_preconditioner, ddtheta_difference_preconditioner
  real(prec), dimension(:,:), allocatable, target :: ddzeta_sum, ddzeta_difference, ddzeta_sum_preconditioner, ddzeta_difference_preconditioner
  ...
  real(prec), dimension(:), allocatable :: L_scaling
  ...
  Vec, dimension(1) :: null_vecs, transpose_null_vecs
