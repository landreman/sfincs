...
contains
  ...
  subroutine readNamelistInput()
    ...
    namelist / physicsParameters / Delta, gamma, nu_n, EParallelHat, &
         collisionOperator, constraintScheme, includeXDotTerm, &
         includeElectricFieldTermInXiDot, ExB_option, &
    ...
    namelist / otherNumericalParameters /  &
         useIterativeLinearSolver, theta_derivative_option, zeta_derivative_option, &
    ...
    namelist / preconditionerOptions / preconditioner_x, preconditioner_zeta_derivative_option, &
         ...
         preconditioner_field_term_xi_option, preconditioning_option, preconditioner_collision_multiplier, &
         preconditioner_theta_blend, preconditioner_zeta_blend, preconditioner_xi_blend
