...
contains
  ...
  subroutine initializeOutputFile()
    ...
    if (masterProc) then
       ...
       call writeHDF5Field("alpha_derivative_option", alpha_derivative_option, "")
       call writeHDF5Field("zeta_derivative_option", zeta_derivative_option, "")
       call writeHDF5Field("xi_derivative_option", xi_derivative_option, "")
       call writeHDF5Field("xi_quadrature_option", xi_quadrature_option, "")
       call writeHDF5Field("pitch_angle_scattering_option", pitch_angle_scattering_option, "")
       ...
       call writeHDF5Field("preconditioner_alpha_derivative_option", preconditioner_alpha_derivative_option, "")
       call writeHDF5Field("preconditioner_zeta_derivative_option", preconditioner_zeta_derivative_option, "")
       call writeHDF5Field("preconditioner_xi_derivative_option", preconditioner_xi_derivative_option, "")
	  ...
	  call writeHDF5Field("adiabaticTHat", adiabaticTHat, "Average temperature of adiabatic species, in units of TBar.")
       ...
       call writeHDF5Field("ExB_option", ExB_option, "")
