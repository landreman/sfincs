...
contains
  ...
  subroutine readNamelistInput()
    ...
    namelist / resolutionParameters / forceOddNalphaAndNzeta, &
         Nalpha, &
         Nzeta, &
         Nxi, &
         NL, &
    ...
    namelist / otherNumericalParameters /  &
         useIterativeLinearSolver, alpha_derivative_option, zeta_derivative_option, &
         xi_derivative_option, alpha_interpolation_stencil, pitch_angle_scattering_option, &
