function m20140101_01_plotSFINCSFortranMultiSpeciesConvergenceScan()

% This script is designed to plot results of the multi-species version of
% SFINCS for runs with only 1 species.
