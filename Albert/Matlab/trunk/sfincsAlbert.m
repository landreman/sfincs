...
% potentials.
% Memory and time requirements do NOT depend strongly on this parameter.
NxPotentialsPerVthConverged = 10;
%NxPotentialsPerVths = [40, 81];
NxPotentialsPerVths = floor(linspace(80,120,3));
...
figure
surf(theta2D, zeta2D, 1./BHat.^2); % view(30, 30);
shading interp;
light;
lighting phong;
